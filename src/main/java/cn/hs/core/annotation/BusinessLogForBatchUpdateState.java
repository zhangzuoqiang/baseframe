/*
 * $Log: BusinessLogForBatchUpdateState.java,v $
...
/**
 * Title: BusinessLogForBatchUpdateState<br>
 * Description: 业务日志对应批量更新状态操作注解<br>
 * Company: ORCHIS<br>
...
@Documented
public @interface BusinessLogForBatchUpdateState {
	 ...
	 * @return
	 */
	int operationType() default MaintenanceLog.OPERATION_TYPE_BATCHUPDATESTATE;
