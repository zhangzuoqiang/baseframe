package cn.hs.module.email.serverconfig.domain.jsonbean;

import java.io.Serializable;

/**
 * Title: MailServerConfigJsonBean<br>
 * Description: 邮件服务器配置Json传输对象<br>
 * Company: GOLDGOV<br>
 ...
 * @version $Revision$
 */
public class MailServerConfigJsonBean implements Serializable {
